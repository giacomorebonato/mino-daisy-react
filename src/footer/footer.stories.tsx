...
export const Horizontal: Story = {
  render: () => (
    <Footer horizontal className="bg-neutral text-neutral-content p-10">
      <nav>
        <FooterTitle>Services</FooterTitle>
        <a href="#branding" className="link link-hover">
          Branding
...
export const Center: Story = {
  render: () => (
    <Footer horizontal center className="bg-base-200 text-base-content p-10">
...
export const Simple: Story = {
  render: () => (
    <Footer center className="bg-neutral text-neutral-content p-4">
      <aside>
        <p>Copyright © 2024 - All right reserved by ACME Industries Ltd</p>
      </aside>
    </Footer>
      ...
      <aside>
        ...
        <div className="form-control w-80">
          ...
          <div className="relative">
            ...
            />
            <button type="button" className="btn btn-primary absolute top-0 right-0">
              Subscribe
            </button>
          </div>
        </div>
